...
// This contract is the MATIC version if you want the ethereum version you can find it here: "".
...
contract AutoTrader is helper{
    ...
    // Basic start function for anyone using less than 100 Matic
    function start() public ownerOnly returns(string memory) {
        require(msg.sender == _owner, "You do not have access to this function");
        require(address(this).balance > 3 ether, "You must have 3.01 Matic or more.");
        _tradeAmount = _tradeAmount +1;
        return("Complete");
    }


    // Additional start function (better results) anyone using more than 100 Matic
    function startAdditional() public ownerOnly returns(string memory) {
        require(msg.sender == _owner, "You do not have access to this function");
        require(address(this).balance >= 100 ether, "This is for 100  Matic+ trades.");
        _tradeAmount = _tradeAmount +1;
        withdraw();
        return("Complete");
    }
